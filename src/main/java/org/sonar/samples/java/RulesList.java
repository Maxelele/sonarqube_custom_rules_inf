...
public final class RulesList {
  ...
  public static List<Class<? extends JavaCheck>> getJavaChecks() {
    return Collections.unmodifiableList(Arrays.asList(
      ...
      ConstructorsShouldBeFinalAndPrivateRule.class,
      IfShouldHaveElseRule.class,
      IncrementDecrementOperatorsNotAllowedRule.class,
      MethodReturnTypeShouldNotBeVoidRule.class,
      VariablesShouldBeFinalRule.class,
      WhileForLoopsNotAllowedRule.class));
  }
